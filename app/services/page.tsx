  ...
  const serviceHighlights = [
    {
      title: "Hair",
      subtitle: "Фризьор",
      text: "Перфектен цвят, стайлинг, сватбени визии, създадени с внимание към личния стил.",
    },
    {
      title: "Makeup",
      subtitle: "Грим",
      text: "Soft glam, булчински визии и абитуриентски визии с фотогеничен финал.",
    },
    {
      title: "Nails",
      subtitle: "Маникюр",
